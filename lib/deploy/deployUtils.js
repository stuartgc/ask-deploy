    ...
    validateStrings: ( envData, skipAudioValidation ) => {
        let p = new Promise( function( resolve, reject ) {
            ...
            .then( ( data ) => {
                ...
                let audioPath = utils.get( e.configKey.S3_AUDIO_PATH, envData, "" );
                ...
                if ( tags ) {
                    ...
                    if ( audioPath.length === 0 && fileNames.length > 0 ){
                        return reject( { message: str.ERROR.MISSING.S3_AUDIO_PATH } );
                    }
        ...
        if ( files.length > 0 ){
            ...
            urlExists( file, function( err, exists ) {
                if ( exists ){
                    ...
                    let error = { message: "File doesn't exist: " + file } ;
